...
!function (t, e) {
    ...
    a.width = 200, webix.protoUI({
        ...
        name: "kanbanuploader", $init: function () {
            ...
            this.files.data.scheme({
                $init: function (t) {
                    "string" == typeof t.link && t.link && (t.name = t.name || t.link.split("/").pop(), t.type = t.type || t.name.split(".").pop(), t.status = t.status || "server"), t.sizetext = t.sizetext || i._format_size(t.size)
                }
    ...
    webix.i18n.kanban = {
        ...
        name: "kanban", defaults: {delimiter: ","}, $skin: function () {
            ...
            if ("add" == i) this._assignList(e), this.getOwnerList(t).add(e), e.$index = this._sublists[e.$list].count(); else if ("delete" === i) this._sublists[e.$list].remove(t); else if ("update" === i || "paint" === i) {
                var n = e.$list;
                this._assignList(e), n === e.$list ? this.getOwnerList(t).updateItem(t, e) : (this._sublists[n].remove(t), this.getOwnerList(t).add(e))
            }
            ...
            for (var a = 0; a < this._sublists.length; a++) {
                ...
                t.push({id: a.toString(), value: o}), s.config.master = this.config.id, s.type.master = this.config.id
            }
